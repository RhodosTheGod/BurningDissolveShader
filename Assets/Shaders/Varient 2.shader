Shader "BurningDissolve/Varient 2"
{
    Properties
    {
        ...
        _Burn ("Burn", Range(0.0,1.1)) = 1.1
        _Dissolve ("Dissolve", Range(0.0,1.1)) = 0.0
    ...
    SubShader
    {
        ...
        fixed4 _Warm, _Hot;
        half _DistortionAmount, _ScrollSpeed, _Contrast, _Burn, _HeatWave, _Dissolve, _BurnDirX, _BurnDirY;
        ...
        void surf(Input IN, inout SurfaceOutput o)
        {
            ...
            fixed4 animatedTexture = tex2D(_Mask, uvDisplacement + IN.uv_Mask + uvTranslation); //inside burning
            float burnTexture = tex2D(_Mask, IN.uv_Mask  + uvDisplacement).r; //dissolve / heatwave etc.
            ...
            //dissolve
            half smallerDissolve  = step(burnTexture, 1 - _Dissolve);
            half biggerDissolve = step(burnTexture, 1 - (_Dissolve / 1.1));
